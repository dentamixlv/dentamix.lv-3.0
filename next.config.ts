        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.prismic.io https://*.convex.cloud wss://*.convex.cloud https://generativelanguage.googleapis.com https://*.posthog.com https://*.i.posthog.com https://*.google-analytics.com https://*.analytics.google.com;",
              "img-src 'self' data: blob: https://*.prismic.io https://images.unsplash.com https://images.prismic.io https://*.posthog.com https://*.i.posthog.com https://*.google-analytics.com https://www.googletagmanager.com;",
