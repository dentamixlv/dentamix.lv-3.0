...
export const BLOG_POSTS_LV: BlogPost[] = [
  ...
  },
  {
    ...
    detailedContent: [
      ...
      'Lai gan abas metodes spēj sasniegt izcilu rezultātu, kapes parasti prasa īsāku kopējo ārstēšanas laiku un mazāk steidzamu vizīšu klīnikā. Mūsu speciālisti Dentamix veiks detalizētu 3D skenēšanu, lai jau pirmajā vizītē parādītu Jūsu nākotnes smaida digitālo modeli un izplānotu visprecīzāko ārstēšanas gaitu.'
    ],
  ...
  },
  {
    ...
    detailedContent: [
      ...
      'Turklāt modernā Digital Smile Design (DSD) tehnoloģija Dentamix klīnikā ļauj Jums piedalīties sava topošā smaida dizaina izveidē. Mēs kopīgi piemeklējam ideālo zobu formu, līniju un baltuma toni, lai tie perfekti saskanētu ar Jūsu sejas pantiem, lūpām un mīmiku. Tā ir ilgtermiņa investīcija – porcelāns nemaina krāsu un nekrāsojas no pārtikas vai dzērieniem, priecējot Jūs daudzu gadu garumā.'
    ],
...
export const BLOG_POSTS_EN: BlogPost[] = [
  {
    ...
    detailedContent: [
      ...
      'Professional hygiene once a year or every six months helps eliminate hard tartar and microbial plaque in areas that cannot be reached with a regular toothbrush and dental floss. At Dentamix clinic, we use the gentle and innovative Air-Flow technology, which thoroughly cleans the tooth surface from coffee or tea stains without causing discomfort.',
  ...
  },
  {
    ...
    detailedContent: [
      ...
      'Although both methods can achieve excellent results, aligners usually require shorter treatment times and fewer emergency clinic visits. Our specialists at Dentamix will perform a detailed 3D scan to show you a digital model of your future smile and plan the most precise treatment right at your first visit.'
    ],
    image: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?auto=format&fit=crop&q=80&w=800',
    date: '10 May, 2026',
  ...
  },
  {
    ...
    detailedContent: [
      ...
      'Furthermore, modern Digital Smile Design (DSD) technology at Dentamix clinic allows you to participate in creating your future smile design. We together select the ideal tooth shape, alignment, and shade of whiteness to perfectly match your facial features, lips, and expressions. This is a long-term investment - porcelain does not change color or stain from food or drinks, bringing you joy for many years.'
    ],
    image: 'https://images.unsplash.com/photo-1513223564055-2005be73a3aa?auto=format&fit=crop&q=80&w=800',
    date: '1 May, 2026',
