...
export const SERVICES_LV: Service[] = [
  {
    ...
    detailedInfo: 'Mūsdienīga terapeitiskā ārstēšana klīnikā Dentamix ļauj droši un maksimāli saglabāt zobu dabisko struktūru. Izmantojam bioloģiski saderīgus, augstākās klases kompozītmateriālus ar augstu nodilumizturību. Veicam augstas sarežģītības zobu sakņu kanālu ārstēšanu (endodontiju) jaudīga mikroskopa kontrolē, kas ļauj ieraudzīt pat vissmalkākās anatomiskās nianses un novērst infekcijas atkārtošanos.',
    priceRange: 'no 60 €',
    duration: '30 - 60 min',
