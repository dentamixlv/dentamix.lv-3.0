          ...
          >
            <div className="px-6 pt-3.5 pb-6 flex flex-col gap-0">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full mt-3 inline-flex items-center justify-center gap-2 bg-[#009FE5] border border-[#009FE5] text-white hover:bg-[#008ecf] hover:border-[#008ecf] px-6 py-3.5 rounded-full text-sm font-bold transition-all shadow-md shadow-[#009FE5]/20"
