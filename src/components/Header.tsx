            ...
            <div className="px-6 pt-3 pb-6 flex flex-col gap-0">
              {navItems.map((item) => (
                <Link
                  ...
                  className={`text-left text-sm font-bold uppercase tracking-widest py-2.5 border-b border-white/10 ${
              ...
              {isEn ? (
                <Link
                  href={getLanguagePath('lv')}
                  onClick={() => setMobileMenuOpen(false)}
                  className="text-left text-sm font-bold uppercase tracking-widest py-2.5 border-b border-white/10 text-white/80 hover:text-white transition-colors cursor-pointer"
              ...
              <Link
                ...
                onClick={() => setMobileMenuOpen(false)}
                className="w-full mt-6 inline-flex items-center justify-center gap-2 bg-[#de7c8a] text-white hover:bg-[#e38c98] px-6 py-3.5 rounded-full text-sm font-bold shadow-md shadow-[#511B29]/20"
