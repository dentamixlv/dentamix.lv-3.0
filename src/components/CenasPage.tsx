...
const getCategoryIcon = (id: string) => {
  switch (id) {
    case 'diagnostika': return <Activity className="w-5 h-5 text-[#de7c8a]" />;
    case 'arstesana': return <ShieldCheck className="w-5 h-5 text-[#de7c8a]" />;
    case 'kanali': return <Activity className="w-5 h-5 text-[#de7c8a]" />;
    case 'higiena': return <Droplet className="w-5 h-5 text-[#de7c8a]" />;
    case 'balinasana': return <Sparkles className="w-5 h-5 text-[#de7c8a]" />;
    case 'bernu': return <Heart className="w-5 h-5 text-[#de7c8a]" />;
    case 'kirurgija': return <Scissors className="w-5 h-5 text-[#de7c8a]" />;
    case 'implanti': return <Activity className="w-5 h-5 text-[#de7c8a]" />;
    case 'protezesana-implanti': return <Sparkles className="w-5 h-5 text-[#de7c8a]" />;
    case 'protezesana': return <Sparkles className="w-5 h-5 text-[#de7c8a]" />;
    case 'kapes': return <ShieldCheck className="w-5 h-5 text-[#de7c8a]" />;
    default: return <HelpCircle className="w-5 h-5 text-[#de7c8a]" />;
  }
};

export default function CenasPage({ onBook, langCode = 'lv', priceItems = [] }: CenasPageProps) {
