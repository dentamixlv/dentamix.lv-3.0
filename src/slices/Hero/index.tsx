        ...
        >
          {isFilled.link(primary.cta_link) ? (
            <PrismicNextLink
              ...
              className="px-8 py-4 bg-[#de7c8a] hover:bg-[#e38c98] active:scale-[0.98] text-[#511B29] rounded-full text-base font-bold shadow-lg shadow-[#de7c8a]/25 transition-all text-center cursor-pointer inline-flex items-center justify-center gap-2 group"
              id="hero-primary-btn"
            >
              {ctaText}
